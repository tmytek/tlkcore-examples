...
if __name__ == '__main__':
	...
	while True:
		print("================================================================================")
		print("Usage :")
		print("ch1_db : In range(Minimum_Gain, Maximum_Gain, 0.5)")
		print("ch2_db : In range(Minimum_Gain, Maximum_Gain, 0.5)")
		print("ch3_db : In range(Minimum_Gain, Maximum_Gain, 0.5)")
		print("ch4_db : In range(Minimum_Gain, Maximum_Gain, 0.5)")
